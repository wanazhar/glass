...
| Platform and release truth | `docs/feature-parity.md`, `docs/ci-platform-certification.md`, `docs/local-platform.md`, `docs/release-checklist.md`, `docs/release-evidence.md`, `docs/releases/0.3.5.md`, `docs/tag-signing.md` | Correct current-versus-historical claims, require substantive exact-tag notes and truthful signature verification; do not turn source checks into native certification. |
...
| Evidence and migration | `docs/demo.md`, `docs/migration/issue-31.md`, `docs/migration/0.3.5.md`, `docs/design/v0.3.3/README.md` | Keep intentionally bounded evidence, document the 0.3.4-to-0.3.5 package/trust/runtime transition, route readers to current guides, and label historical scope. |
