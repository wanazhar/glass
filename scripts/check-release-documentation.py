...
REQUIRED_MARKERS = {
    "README.md": ["| 0.2.5 | Current published release |", "docs/feature-parity.md", "docs/release-evidence.md"],
    "CHANGELOG.md": ["## [0.2.5] - 2026-08-01", "## [Unreleased] — 0.2.6"],
    "docs/release-checklist.md": [
        "current published release is `glass-browser` version `0.2.5`",
        "next crates.io release, `0.2.6`",
        "GitHub release binaries, checksum manifests",
    ],
    "docs/feature-parity.md": [
        "published 0.2.5 baseline",
        "0.2.6 work stream",
    ...
    "docs/plan/analysis/release-audit-028.md": [
        ...
        "`0.2.5 published; source-only GitHub Release",
        "`0.2.6 local development; not ready for",
    ],
}
FORBIDDEN_MARKERS = (
