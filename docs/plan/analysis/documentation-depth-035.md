...
| Platform and release truth | `docs/feature-parity.md`, `docs/ci-platform-certification.md`, `docs/local-platform.md`, `docs/release-checklist.md`, `docs/release-evidence.md`, `docs/releases/0.3.5.md`, `docs/releases/0.3.6.md`, `docs/releases/0.3.7.md`, `docs/releases/0.3.8.md`, `docs/tag-signing.md` | Correct current-versus-historical claims, require substantive exact-tag notes and truthful signature verification; do not turn source checks into native certification. |
