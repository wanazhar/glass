...
| Development workspace | `docs/development-runtime.md`, `docs/workspace-trust.md`, `docs/pi-sdk-runtime.md`, `docs/task-dag.md`, `docs/experiments.md`, `docs/debugger.md`, `docs/kernels.md`, `docs/development-graph.md`, `docs/architecture/development-tui.md`, `docs/architecture/mobile-cockpit.md`, `docs/architecture/tui.md` | Expand trust, Pi, task, experiment, debugger, kernel, typed graph/replay, files/editor/process/LSP/timeline/agent lifecycles, views, errors, and recovery. |
