...
def main() -> None:
    ...
    if matrix.get("next_release") != "0.3.2":
        fail("next_release must be 0.3.2")
    ...
    required_text = {
        "README.md": "| 0.3.2-rc.1 | Current local release candidate |",
        "CHANGELOG.md": "## [0.3.0] - 2026-08-06",
        "docs/release-checklist.md": "release checkout is `glass-browser` and `glass-dev` version `0.3.2-rc.1`",
