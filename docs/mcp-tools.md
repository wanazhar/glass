...
This catalog names every browser tool in the `0.3.8` client-conformance inventory.
...
compatibility vocabulary. They are not part of the 0.3.8 negotiated inventory
