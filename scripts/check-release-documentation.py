...
REQUIRED_MARKERS = {
    "README.md": [
        "| `glass-browser 0.3.9`, `glass-dev 0.3.9` | Current release source; public registry state is recorded in release evidence |",
    ...
    "docs/release-checklist.md": [
        "release checkout is `glass-browser` and `glass-dev` version `0.3.9`",
...
def main() -> None:
    ...
    if package_version != "0.3.9":
        fail(f"release checkout must use package version 0.3.9, not {package_version}")
