...
pub use knowledge::{
    ...
    KnowledgeCurrentValidationStatus, KnowledgeEmbeddingProvider, KnowledgeEvidenceQuality,
    KnowledgeGraph, KnowledgeGraphEdge, KnowledgeGraphNode, KnowledgeGraphNodeKind,
    KnowledgeGraphTraversal, KnowledgeInvalidation, KnowledgeLearningPolicy,
    KnowledgeLearningRequest, KnowledgeLearningResult, KnowledgeLifecycleEvent,
    KnowledgeLookupContext, KnowledgeLookupOptions, KnowledgeMemoryInfluence,
    KnowledgeObservationMode, KnowledgeObservationReport, KnowledgePortability,
    KnowledgeProfileScope, KnowledgeRecord, KnowledgeRecordBuildOptions, KnowledgeRecordKind,
    KnowledgeRejectionReason, KnowledgeRetrievalCandidate, KnowledgeRetrievalExplanation,
    KnowledgeRetrievalQuery, KnowledgeRetrievalReport, KnowledgeRetrievalSignal,
    KnowledgeRetrievalSignalKind, KnowledgeScope, KnowledgeScopeSelector, KnowledgeSignalKind,
