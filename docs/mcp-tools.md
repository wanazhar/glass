...
| `glass.task` | `glass.task.cancel`, `glass.task.create`, `glass.task.evidence`, `glass.task.get`, `glass.task.list`, `glass.task.override-blocked`, `glass.task.pause`, `glass.task.plan`, `glass.task.reassign`, `glass.task.resume`, `glass.task.retry` | Value-free task compilation plus autonomous verified DAG lifecycle and evidence. |
