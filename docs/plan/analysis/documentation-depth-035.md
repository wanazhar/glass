...
| Installation and governance | `docs/installation.md`, `SECURITY.md`, `CONTRIBUTING.md`, `docs/documentation-style.md`, `docs/ownership.md` | Preserve verified install/uninstall detail; deepen lifecycle, contribution, trust, and documentation acceptance where missing. |
...
| Development workspace | `docs/development-runtime.md`, `docs/architecture/development-tui.md`, `docs/architecture/mobile-cockpit.md`, `docs/architecture/tui.md` | Expand files/editor/process/LSP/graph/timeline/experiment/agent lifecycles, views, errors, and recovery. |
...
| Platform and release truth | `docs/feature-parity.md`, `docs/ci-platform-certification.md`, `docs/local-platform.md`, `docs/release-checklist.md`, `docs/release-evidence.md` | Correct current-versus-historical claims; do not turn source checks into native certification. |
...
| Evidence and migration | `docs/demo.md`, `docs/migration/issue-31.md`, `docs/design/v0.3.3/README.md` | Keep intentionally bounded evidence, but route readers to current guides and label historical scope. |
