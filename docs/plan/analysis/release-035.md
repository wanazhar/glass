...
| III / Gate 3 Boundary | no browser development feature, no browser-owned project core, no fallback dispatch; three package checks | Core extracted and feature removed; CLI fallback and deprecated browser compatibility module still pending |
