...
REQUIRED_MARKERS = {
    "README.md": [
        "| `glass-browser 0.3.10`, `glass-dev 0.3.10` | Current release source; public registry state is recorded in release evidence |",
    ...
    "docs/release-checklist.md": [
        "release checkout is `glass-browser` and `glass-dev` version `0.3.10`",
...
def main() -> None:
    ...
    if package_version != "0.3.10":
        fail(f"release checkout must use package version 0.3.10, not {package_version}")
