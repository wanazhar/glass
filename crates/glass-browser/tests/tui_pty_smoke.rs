...
fn phone_tui_renders_and_leaves_a_real_terminal_cleanly() {
    ...
    assert_sequence(&output, b"\x1b[?1004h", "enable focus reporting");
    assert_sequence(&output, b"\x1b[?2004h", "enable bracketed paste");
    ...
    assert_sequence(&output, b"\x1b[?1004l", "disable focus reporting");
    assert_sequence(&output, b"\x1b[?2004l", "disable bracketed paste");
